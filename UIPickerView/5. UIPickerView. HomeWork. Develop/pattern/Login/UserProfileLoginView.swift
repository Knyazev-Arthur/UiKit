...
// MARK: - UserProfileLoginViewProtocol
protocol LoginUserProfileViewProtocol {
    ...
    @objc func logInButtonAction() {
        ...
        UIView.animate(withDuration: 0.1, animations: { // задержка 0.1 секунда
            ...
            UIView.animate(withDuration: 0.1, animations: {
                self.logInButton.transform = CGAffineTransform.identity // возврат размера в исходное состояние
            }) { _ in // завершение второй анимации вызывает замыкание, выполняющее переход на другой экран
                let controller = BirthdayViewController()
