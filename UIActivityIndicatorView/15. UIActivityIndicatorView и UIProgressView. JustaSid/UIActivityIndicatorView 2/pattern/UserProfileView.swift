...
class UserProfileView: UIView {
    ...
    private func setupProgressViewConstraints() {
        ...
        let top = progressView.topAnchor.constraint(equalTo: imageView.bottomAnchor, constant: 16)
        let centerX = progressView.centerXAnchor.constraint(equalTo: self.centerXAnchor)
        let width = progressView.widthAnchor.constraint(equalTo: imageView.widthAnchor)
    ...
    private func setupButtonConstraints() {
        ...
        let top = button.topAnchor.constraint(equalTo: progressView.bottomAnchor, constant: 16)
        let centerX = button.centerXAnchor.constraint(equalTo: self.centerXAnchor)
        let width = button.widthAnchor.constraint(equalTo: progressView.widthAnchor)
