...
class ViewController: UIViewController {
    ...
    @objc private func updateTextView(notification: Notification) { //
        ...
        let buttonLeftBottomConstraint = userProfileView.buttonLeftBottomConstraint.constant * 2
        ...
        if notification.name == UIResponder.keyboardWillHideNotification { // если полученно уведомление о скрытии клавиатуры
            ...
            textView.contentInset = UIEdgeInsets(top: 0, left: 0, bottom: keybordFrame.height + buttonLeftBottomConstraint, right: 0) // поднимаем текст
